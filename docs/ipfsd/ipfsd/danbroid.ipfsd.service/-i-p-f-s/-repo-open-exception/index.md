...
# RepoOpenException  
 [androidJvm] open class [RepoOpenException](index.md) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)   
...
|  Name|  Summary| 
|---|---|
| [RepoOpenException](-repo-open-exception.md)|  [androidJvm] open fun [RepoOpenException](-repo-open-exception.md)(message: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html), err: [Throwable](https://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html))   <br>
