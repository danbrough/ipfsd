...
# RepoInitException  
 [androidJvm] open class [RepoInitException](index.md) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)   
...
|  Name|  Summary| 
|---|---|
| [RepoInitException](-repo-init-exception.md)|  [androidJvm] open fun [RepoInitException](-repo-init-exception.md)(message: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html))   <br>
| [RepoInitException](-repo-init-exception.md)|  [androidJvm] open fun [RepoInitException](-repo-init-exception.md)(message: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html), err: [Throwable](https://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html))   <br>
