...
# ExtraOptionException  
 [androidJvm] open class [ExtraOptionException](index.md) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)   
...
|  Name|  Summary| 
|---|---|
| [ExtraOptionException](-extra-option-exception.md)|  [androidJvm] open fun [ExtraOptionException](-extra-option-exception.md)(message: [String](https://docs.oracle.com/javase/8/docs/api/java/lang/String.html), err: [Throwable](https://docs.oracle.com/javase/8/docs/api/java/lang/Throwable.html))   <br>
