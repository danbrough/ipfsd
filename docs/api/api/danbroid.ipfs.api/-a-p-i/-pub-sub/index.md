...
# PubSub  
 [jvm] class [PubSub](index.md)(**api**: [API](../index.md))   
...
| [subscribe](subscribe.md)| [jvm]  <br>Content  <br>fun [subscribe](subscribe.md)(topic: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), discover: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)): [ApiCall](../../-api-call/index.md)<[Types.PubSub.Message](../../-types/-pub-sub/-message/index.md)>  <br><br><br>
