...
# Name  
 [jvm] class [Name](index.md)(**api**: [API](../index.md))   
...
| [publish](publish.md)| [jvm]  <br>Brief description  <br><br><br>Publish IPNS names<br><br>  <br>Content  <br>fun [publish](publish.md)(path: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), resolve: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html), lifetime: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?, key: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?): [ApiCall](../../-api-call/index.md)<[Types.NameValue](../../-types/-name-value/index.md)>  <br><br><br>
